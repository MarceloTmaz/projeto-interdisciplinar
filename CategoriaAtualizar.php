<?php
    ...
    $categoria=filter_input(INPUT_GET, "idCatecoria");
...
<html>
    ...
    <body>
        ...
        <form action="./CategoriaControle.php" method="get" >
             ...
             <input type="text" class="form-control" value="<?php echo $desc?>" name="nomeCate"><br>
             <input type="number" value="<?php echo $categoria; ?>" name="idCate" hidden="true">
