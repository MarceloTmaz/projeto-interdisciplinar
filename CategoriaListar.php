  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav">
        ...
        <?php }
        echo '<td> <form action="./categoriaCriar.php" method="get" >
             <input  class="btn btn-dark" type="submit" name="ref"  value="Criar">
             </form>';
        ...
        if($b==false){
            ...
            foreach ($b as $li) {
                ...
                if($li->getIdU()==$idU){
                echo '<td class="table-dark"> <form action="./CategoriaControle.php" method="get" >
             <input type="number" value="';
                echo  $li->getId() ;
                echo '" name="idcate" hidden="true">
                    <input type=text value="'.$li->getDescricao().'" name="desc" hidden="true">
             ...
             <input type="number" value="';
                echo  $li->getId() ;
                echo '" name="idcate" hidden="true">
             <input type="submit" class="btn btn btn-light" name="ref" value="Deletar">            
                </form> </td>';}
                echo '<td class="table-dark"> <form action="./NoticiaControle.php" method="get" >
             <input type="number" value="';
                echo  $li->getId() ;
                echo '" name="idcate" hidden="true">
             <input type="submit" class="btn btn-light" name="ref" value="listarNoticia">            
        </form> </td>';
                }
                echo "</tr>";
