  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav">
        ...
        <?php } 
        echo '<td> <form action="./EventoControle.php" method="get" >
            <input type="number" name="idJogo" value="';        
        echo '" hidden="true">
            <input  class="btn btn-dark" type="submit" name="ref"  value="CriarEvento">
             </form>';
        ...
        if($b==false){
            ...
            echo '<td class=" fs-5 table-dark">Nome </td><td class=" fs-5 table-dark" colspan=3>Ação</td>';
            echo "</tr>";
            ...
            foreach ($b as $li) {
                ...
                echo '<tr class="table-dark">';
                echo '<td class=" fs-5 table-dark">' . $li->getNome() . "</td>";
                if($li->getIdUsuario()==$idU){
                echo '<td class="table-dark"> <form action="./EventoControle.php" method="get" >
             <input type="number" value="';
                echo  $li->getIdevento() ;
                echo '" name="id" hidden="true">
                    <input type="text" value="';
                echo  $li->getDescricao() ;
                echo '" name="descricao" hidden="true">
                     <input type="text" value="';
                echo  $li->getNome() ;
                echo '" name="nome" hidden="true">
                    <input type="text" value="';
                echo  $li->getLocal() ;
                echo '" name="local" hidden="true">
                         <input type="date" value="';
                echo  $li->getData() ;
                echo '" name="data" hidden="true">
             ...
             <input type="number" value="';
                echo  $li->getIdevento() ;
                echo '" name="id" hidden="true">
             <input type="submit" class="btn btn-light" name="ref" value="detalhe">            
        </form> </td>';
                echo "</tr>";
            }
            echo "</table>";
