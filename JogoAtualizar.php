<?php
    ...
    $jogo=filter_input(INPUT_GET, "idJogo");
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav">
        ...
        <?php } ?>
     <form action="./JogoControle.php" method="get" >
             <label class=" fs-5">Nome: </label><br><!-- comment -->
             <input type="text" value="<?php echo "$nome";?>" class="form-control" name="nomeJogo"><br>
             <input type="number" value="<?php echo $id; ?>" name="idUser" hidden="true">
             <input type="number" value="<?php echo $jogo; ?>" name="idjogo" hidden="true">
             <label class=" fs-5"> Descrição: </label><br>
             <input type="text" value="<?php echo $descricao;?>"class="form-control" name="descricao"><br>
