  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav">
        ...
        <?php } 
        echo '<td> <form action="./JogoCriar.php" method="get" >
             <input type="submit" class="btn btn-dark" name="ref"  value="Criar">
             </form>';
        if($b==false){
            echo '<p class="text-start">Nenhum registro retornado.</p>';         
        } else {
            if ($b) {
               // echo $b[0]->getNome();
            ...
            echo '<td class="table-dark  fs-5 ">Nome</td><td class="  fs-5 table-dark">descrição</td><td class=" fs-5 table-dark"colspan=4>Ação</td>';
            echo "</tr>";
            ...
            foreach ($b as $li) {
                ...
                echo '<td> <form action="./JogoControle.php" method="get" >
